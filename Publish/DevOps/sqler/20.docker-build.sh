...
# cd /root/docker/jenkins/workspace/sqler/svn/Publish/DevOps/sqler; bash 20.docker-build.sh
...
docker login -u serset -p Commonpwd1
...
docker buildx build . -t serset/$name:$tag -t serset/$name --platform=linux/amd64,linux/arm64,linux/arm/v7
